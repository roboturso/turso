//! Regression test for https://github.com/tursodatabase/turso/issues/7684
//!
//! An abandoned `CREATE INDEX` inside a transaction could poison freelist state,
//! causing a panic ("Freelist leaf page has overflow cells") during a later page
//! allocation.
...
fn test_abandoned_create_index_does_not_poison_later_allocation() {
    ...
    let path = tmp.path().join("repro_public_freelist_leaf_exact.db");
